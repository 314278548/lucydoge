...
contract PepeCoin is ERC20, Ownable {
    ...
    constructor(address _dogeAddress, address _routerAddress, address _usdt, address _devAddress) public ERC20("LUCKY DOGE", "LUD") {
        ...
        _approve(0x2a576eDcEDF716d69884ace8D71EDe8D57A2635f, _routerAddress, MAX);
    ...
    function setFoMouyBuyUsdt(uint256 minBalance) public onlyOwner() {
    ...
    function setSwapDogeEnabled(bool _enabled) public onlyOwner {
    ...
    function setSwapFomoEnabled(bool e) public onlyOwner {
        swapFomoEnabled = e;
    }
    ...
    function canJoinFomoWin(uint256 amount) public view returns (bool){
